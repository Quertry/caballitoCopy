...
GamePlayManager = {
    ...
    preload: function() {
        ...
        game.load.audio('gOver','assets/sounds/gameOver.mp3');
    ...
    create: function() {
        ...
        //let mLoop = game.add.audio('musicLoop');
        //if(this.flagFirstMouseDown){
        //    mLoop.play;
        //}

        //Agregando los sonidos
        let gOver = game.add.audio('gOver');
            sonido = game.add.audio('musicLoop');
            victory = game.add.audio('victory');
            pop = game.add.audio('sfxPop');

        //sonido.addMarker(this.flagFirstMouseDown, 0,30);
        //sonido.play();
        ...
        this.timerGameOver = game.time.events.loop(Phaser.Timer.SECOND, function(){
            if(this.flagFirstMouseDown){
                ...
                if(this.totalTime<=0){
                    ...
                    // Agregando sonido de derrota
                    gOver.play();
                    this.showFinalMessage('GAME OVER');
                    // Pausando sonido de fondo
                    sonido.pause();
                }
            }
        },this);
    ...
    showFinalMessage:function(msg){
        ...
        // Punto de referencia del mensaje (la mitad)
    ...
    onTap:function(){
        ...
        // Agregand sonido de fondo
        sonido.play().loopFull(0.4);
    },
        ...
        if(this.flagFirstMouseDown && !this.endGame){
            ...
            for(var i=0; i<AMOUNT_DIAMONDS; i++){
                ...
                if(this.diamonds[i].visible && this.isRectanglesOverlapping(rectHorse, rectDiamond)){
                    ...
                    // Agregar sonido de explosion a las burbujas
                    pop.play();
...
// Instanciando un nuevo juego en phaser, dimensiones 
// y tipo de render CANVAS o WEBGL
let game = new Phaser.Game(1136, 640, Phaser.AUTO);
    
// Agregando un estado ('id', objeto)
